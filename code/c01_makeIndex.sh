...
#Downloaded from: ftp://ftp.ensembl.org/pub/release-87/fasta/macaca_mulatta/dna/Macaca_mulatta.Mmul_8.0.1.dna_sm.toplevel.fa.gz
GenomeFA=/u/home/g/gandalm/project-geschwind/RefGenome/Macaca_mulatta/Mmul_8/Sequence/WholeGenomeFasta/Macaca_mulatta.Mmul_8.0.1.dna_sm.toplevel.fa
...
${STARcall} --runThreadN 8 --runMode genomeGenerate --genomeFastaFiles $GenomeFA --sjdbGTFfile $GTF --genomeDir $STARindex
